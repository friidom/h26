const item1 = document.querySelector('.photo1')
const item2 = document.querySelector('.photo2')
...
let m1 = './img/photo1.png'
let m2 = './img/kid.png'
box1.addEventListener("dragover", dragover1);
box2.addEventListener("dragover", dragover1);
box1.addEventListener("drop", dragdrop1);
box2.addEventListener("drop", dragdrop2);
...
function dragdrop1() {
    if (document.getElementById("iten").src = m1) {
        document.getElementById("iten").src = m2
        document.getElementById("iten1").src = m1
    } else if (document.getElementById("iten").src = m2){
        document.getElementById("iten").src = m1
        document.getElementById("iten1").src = m2
    }
...
function dragdrop2() {
    if (document.getElementById("iten1").src = m2) {
        document.getElementById("iten").src = m1
        document.getElementById("iten1").src = m2
    }else if (document.getElementById("iten1").src = m1){
        document.getElementById("iten").src = m2
        document.getElementById("iten1").src = m1
    }
...
// box1.addEventListener("drop", dragdrop);
...
// puc.addEventListener("dragstart", dragstart);
// puc.addEventListener("dragend", dragend);

// function dragstart() {
//     // puc.classList.add('hold')
//     setTimeout(() => {
//         puc.classList.add('hide')
//     }, 0);
// }
// function dragend() {
//     puc.classList.remove( 'hide')
// }
...
let progres_box = document.querySelector('.progress-box')

function delete_scroll() {
    progres_box.classList.toggle('not_active')
}
